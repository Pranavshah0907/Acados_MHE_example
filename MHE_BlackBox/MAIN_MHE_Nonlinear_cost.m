...
dims.nx = model.nx; % 3 + 2 * hidden states --> 35
dims.nu = model.nu; % 3
...
ocp_model.set('cost_type_e', 'nonlinear_ls');% cost_type);
...
% ocp_model.set('constr_Jsh', Jsh); --> Uncomment this 
