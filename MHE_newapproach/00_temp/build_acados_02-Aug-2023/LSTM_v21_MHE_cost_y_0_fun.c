...
#else
  #define CASADI_PREFIX(ID) LSTM_v21_MHE_cost_y_0_fun_ ## ID
#endif
...
/* LSTM_v21_MHE_cost_y_0_fun:(i0[35],i1[35],i2[],i3[5])->(o0[6]) */
...
CASADI_SYMBOL_EXPORT int LSTM_v21_MHE_cost_y_0_fun(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem){
  return casadi_f0(arg, res, iw, w, mem);
}

CASADI_SYMBOL_EXPORT int LSTM_v21_MHE_cost_y_0_fun_alloc_mem(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT int LSTM_v21_MHE_cost_y_0_fun_init_mem(int mem) {
  return 0;
}

CASADI_SYMBOL_EXPORT void LSTM_v21_MHE_cost_y_0_fun_free_mem(int mem) {
}

CASADI_SYMBOL_EXPORT int LSTM_v21_MHE_cost_y_0_fun_checkout(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT void LSTM_v21_MHE_cost_y_0_fun_release(int mem) {
}

CASADI_SYMBOL_EXPORT void LSTM_v21_MHE_cost_y_0_fun_incref(void) {
}

CASADI_SYMBOL_EXPORT void LSTM_v21_MHE_cost_y_0_fun_decref(void) {
}

CASADI_SYMBOL_EXPORT casadi_int LSTM_v21_MHE_cost_y_0_fun_n_in(void) { return 4;}

CASADI_SYMBOL_EXPORT casadi_int LSTM_v21_MHE_cost_y_0_fun_n_out(void) { return 1;}

CASADI_SYMBOL_EXPORT casadi_real LSTM_v21_MHE_cost_y_0_fun_default_in(casadi_int i){
  switch (i) {
    default: return 0;
  }
}

CASADI_SYMBOL_EXPORT const char* LSTM_v21_MHE_cost_y_0_fun_name_in(casadi_int i){
  switch (i) {
    case 0: return "i0";
    case 1: return "i1";
    case 2: return "i2";
...
CASADI_SYMBOL_EXPORT const char* LSTM_v21_MHE_cost_y_0_fun_name_out(casadi_int i){
  switch (i) {
    case 0: return "o0";
    default: return 0;
  }
...
CASADI_SYMBOL_EXPORT const casadi_int* LSTM_v21_MHE_cost_y_0_fun_sparsity_in(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT const casadi_int* LSTM_v21_MHE_cost_y_0_fun_sparsity_out(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT int LSTM_v21_MHE_cost_y_0_fun_work(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
  if (sz_arg) *sz_arg = 4;
  if (sz_res) *sz_res = 1;
  if (sz_iw) *sz_iw = 0;
  if (sz_w) *sz_w = 0;
